...
| § 30 BetrVG | Betriebsratssitzungen | Meeting-Management: Dokumentation von Ort, Zeit, Teilnehmer |
...
| § 28 BetrVG | Ausschüsse | Ausschussverwaltung: Separate Verwaltung mit delegierten Befugnissen |
| § 37 Abs. 2 BetrVG | Arbeitsbefreiung | Kalendermodul: Dokumentation von BR-Tätigkeiten |
...
- [x] **Unterschrift des Vorsitzenden** → Digitale Genehmigung durch Vorsitz (approved_by_chair)
- [x] **Unterschrift eines weiteren Mitglieds** → Genehmigung durch Protokollführung (approved_by_clerk)
...
- **Nachrück-Reihenfolge:** Nach Listenplatz/Stimmenzahl der Betriebsratswahl.
- **Geschlechterquote:** Das Minderheitengeschlecht darf nicht stärker unterrepräsentiert werden als im Wahlergebnis.
- **Automatisierung:** System ermittelt korrekte Nachrückfolge unter Berücksichtigung aller Regeln.
...
- Privaten Adressen
- Gesundheitsdaten (über den Abwesenheitstyp „Krankheit" hinaus)
...
Für historische Protokolle und Beschlüsse werden personenbezogene Daten anonymisiert (z. B. „Mitglied A hat zugestimmt") anstatt vollständig gelöscht, um die Rechtssicherheit der Dokumentation zu wahren.
...
- Besondere Kategorien personenbezogener Daten verarbeitet werden können (Gewerkschaftszugehörigkeit implizit durch Betriebsratsmitgliedschaft).
...
| 3 | Protokoll wird vom Vorsitz und weiterem Mitglied unterzeichnet | ✅ | Freigabe-Workflow |
