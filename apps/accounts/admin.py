...
from .models import TwoFactorRecoveryCode, User, UserInvitation, UserProfile
...
class UserInvitationAdmin(admin.ModelAdmin):
    ...
    list_display = ['email', 'invited_by', 'created_at', 'expires_at', 'is_used']
    list_filter = ['is_used', 'created_at']
    search_fields = ['email', 'invited_by__email', 'invited_by__first_name', 'invited_by__last_name']
    ordering = ['-created_at']
    ...
    def has_add_permission(self, request):
        """Prevent manual creation of invitations via admin."""
        return False
