        ...
        widgets = {
            ...
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 4,
                    "placeholder": "Beschreibung des Themas und des Beratungsgegenstands...",
                }
            ),
            "propose_to_main_committee": forms.CheckboxInput(
    ...
    def __init__(self, user=None, *args, **kwargs):
        ...
        if user and "committee" in self.fields:
            ...
            if user.is_superuser or user.is_staff:
                ...
                allowed_committees = Committee.objects.filter(is_active=True).exclude(
                ...
                allowed_committees = Committee.objects.filter(
                    id__in=allowed_committee_ids, is_active=True
                )
        ...
        if (
            self.instance.pk
            and hasattr(self.instance, "committee_id")
            and self.instance.committee_id
        ):
